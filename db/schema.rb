...
ActiveRecord::Schema.define(version: 20160130182820) do
  ...
  create_table "organizations", force: :cascade do |t|
    ...
    t.datetime "status_last_checked",            default: '2016-02-16 04:34:19'
    t.datetime "asset_code_last_checked",        default: '2016-02-16 04:34:19'
    t.datetime "income_code_last_checked",       default: '2016-02-16 04:34:19'
    t.datetime "asset_amount_last_checked",      default: '2016-02-16 04:34:19'
    t.datetime "income_amount_last_checked",     default: '2016-02-16 04:34:19'
    t.datetime "revenue_990_last_checked",       default: '2016-02-16 04:34:19'
    t.datetime "affiliation_code_last_checked",  default: '2016-02-16 04:34:19'
    t.datetime "last_return_last_checked",       default: '2016-02-16 04:34:19'
    t.datetime "organization_code_last_checked", default: '2016-02-16 04:34:19'
    t.datetime "ntee_category_last_checked",     default: '2016-02-16 04:34:19'
    t.datetime "ntee_sub_category_last_checked", default: '2016-02-16 04:34:19'
  end
  ...
  create_table "postcards", force: :cascade do |t|
    ...
    t.datetime "created_at",                                                                    null: false
    t.datetime "updated_at",                                                                    null: false
    t.datetime "terminated_last_checked",                       default: '2016-02-16 04:34:19'
    t.datetime "organization_address_line_1_last_checked",      default: '2016-02-16 04:34:19'
    t.datetime "organization_address_state_id_last_checked",    default: '2016-02-16 04:34:19'
    t.datetime "organization_address_postal_code_last_checked", default: '2016-02-16 04:34:19'
  end
  ...
  create_table "revokedorganizations", force: :cascade do |t|
    ...
    t.datetime "created_at",                                                                null: false
    t.datetime "updated_at",                                                                null: false
    t.datetime "city_last_checked",                         default: '2016-02-16 04:34:20'
    t.datetime "legal_name_last_checked",                   default: '2016-02-16 04:34:20'
    t.datetime "exemption_type_last_checked",               default: '2016-02-16 04:34:20'
    t.datetime "revocation_date_last_checked",              default: '2016-02-16 04:34:20'
    t.datetime "revocation_posting_date_last_checked",      default: '2016-02-16 04:34:20'
    t.datetime "exemption_reinstatement_date_last_checked", default: '2016-02-16 04:34:20'
  end
